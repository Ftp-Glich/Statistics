...
\subsection*{5.6 Сравнительный анализ доли выбросов}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{results_lab3/outlier_comparison.png}
\caption{Средняя доля выбросов (\%) для разных распределений}
\label{fig:outlier_comp}
\end{figure}

\begin{table}[H]
\centering
\caption{Средняя доля выбросов (1000 повторений)}
\begin{tabular}{|l|c|c|}
\hline
\textbf{Распределение} & \textbf{n = 20} & \textbf{n = 100} \\
\hline
Нормальное & 5.2\% & 4.8\% \\
Коши & 28.5\% & 31.2\% \\
Лапласа & 8.7\% & 7.9\% \\
...
\subsection*{5.7 Распределения с границами выбросов}
...
\subsection*{5.8 Боксплоты долей выбросов}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{results_lab3/outlier_boxplots.png}
\caption{Распределение долей выбросов (1000 повторений)}
